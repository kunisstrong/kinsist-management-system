<template>
  <div class="home-container">
      ...
      <div class="title">
        <div class="title-item">
          <div class="icon-box visitUser">
            <SvgIcon ref="visitUser" icon="svg-icon:visitUser" :size="50" color="#6bc6c5" />
          </div>
          <div class="item-box">
        ...
        <div class="title-item">
          <div class="icon-box message">
            <SvgIcon icon="svg-icon:message" :size="50" color="#57a1f0" />
          </div>
          <div class="item-box">
        ...
        <div class="title-item">
          <div class="icon-box money">
            <SvgIcon icon="svg-icon:money" :size="50" color="#e25d6f" />
          </div>
          <div class="item-box">
        ...
        <div class="title-item">
          <div class="icon-box shopping">
            <SvgIcon class="icon" icon="svg-icon:shopping" :size="50" color="#61bca4" />
          </div>
          <div class="item-box">
    ...
    <div class="twoRowEcharts">
      ...
      <div id="itemTwo" class="item" style="width: 37%; height: 420px" />
      <div id="itemThree" class="item" style="width: 30%; height: 420px" />
    </div>
  </div>
</template>
