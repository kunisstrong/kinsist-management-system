  ...
  <div class="dept-container">
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model="addFormParams.deptName"
            autocomplete="true"
            clearable
          />
        </el-form-item>
